...
<script>
function showSite(){
	window.open('http://<%=adto.getUrl()%>');
}
function showdal(){
	window.open('http://192.168.20.132:9090/dal.Kom/index.jsp');
}
</script>
<body>
	...
	<section>
		...
		<!-- 배너 -->
		<div class="banner">
			<a href="#"><img alt="배너" src="img/dalkom.png" height="180px" width="800px" onclick="showdal()"></a>
		</div>
		<!-- 로그인 -->
		<div class="login">
		...
		<div class="contentMenu">
			...
			<ul>
				...
				<li><a href="index.jsp?userclick=3">Exchange</a></li>
		...
		<div class="indexAdvertise">
			<a href="#"> <img src="<%=adto.getImgpath()%>" onclick="showSite()"
