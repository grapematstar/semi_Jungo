...
// 추가 수정부분 170402 일 끝
				...
				%>
					...
					<td style="padding-left: 10px;">
 					...
 					%>
						<a href="auctionContent.jsp?idx=<%=arr.get(i).getIdx()%>&cp=<%=cp%>"><%=arr.get(i).getSubject().length()>20?arr.get(i).getSubject().substring(0,20)+"…..":arr.get(i).getSubject()%>
						
						</a></td>
					<td style="text-align: center;"><div id="tag"><a href="#"><%=arr.get(i).getWriter()%></a>
						<ul>
					...
					<td style="text-align: center;"><%=arr.get(i).getWritedate() %></td>
				</tr>
					<%
						}
					}
