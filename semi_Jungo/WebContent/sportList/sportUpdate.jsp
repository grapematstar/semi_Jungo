...
<section>
	<article>
		<h2 align="center"><%=sort%>게시판 글 수정하기</h2>
		...
		<input type="hidden" name="sort" value="<%=sort%>">
			<table class="s_ReWriteTable">
				<tr>
					<th>제목</th>
					<td class="s_ReWriteTable_tdcol" colspan="3"><input type="text" name="subject" size="45" maxlength="33" value="<%=dto.getSubject()%>" required></td>
				</tr>
				<tr>
					<th>내용</th>
