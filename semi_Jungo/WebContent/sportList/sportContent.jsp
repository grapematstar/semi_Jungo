...
function recom(){
	location.href='sportRecom_ok.jsp?idx=<%=dto.getIdx()%>&cp=<%=cp%>',
				...
				<table class="s_ContentTable">
					...
					<tr height="350">
						<td colspan="4" align="left" valign="top">
							<div class="contentImg">
								...
								%>
								<img src="<%=dto.getPicpath()%>" id="img" width="300px"><br>
								<%
									}
								%>
							</div>
					...
					<tr>
						...
						<td colspan="2" style="padding-left: 10px;"><input
							type="text" name="comment" placeholder="내용을 입력해주세요." size="70px;" maxlength="200"></td>
