				...
				<table class="join">
					...
					<tr>
						...
						<td style="border-bottom: solid 1px gray;"><input
							type="password" name="pwd" required="required" maxlength="15"></td>
					</tr>
					<tr>
						<th style="border-bottom: solid 1px gray;">이름</th>
						<td style="border-bottom: solid 1px gray;"><input type="text"
							name="name" required="required" maxlength="6"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><select name="stel" onclick="selectTel()">
							...
							readonly="readonly" maxlength="3"> - <input type="text" name="tel2"
							size="5" required="required" maxlength="4"> - <input type="text"
							name="tel3" size="5" required="required" maxlength="4"></td>
					</tr>
				</table>
				<p>
