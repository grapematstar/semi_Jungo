	...
	public void pointRank(int point, String user) {
		try {
			...
			case 2:
				...
				break;
			case 3:
				sql = "update tt_member set grade=4 where id='" + user + "' and point>=3000 and point<4000";
				break;
			case 4:
				sql = "update tt_member set grade=5 where id='" + user + "' and point>=4000 and point<5000";
				break;
			default : 
				sql = "update tt_member set grade=6 where id='" + user + "' and point>=5000";
			}
